...
# Begin overrides for testing 2020 re-MiniAOD conditions
# Alignment
...
# For re-MiniAOD tests, be sure to use the rebuilt proton collections instead of the ones from the UL RECO
process.ggll_aod.ppsLocalTrackTag = cms.InputTag('ctppsLocalTrackLiteProducer','','TEST')
process.ggll_aod.ppsRecoProtonSingleRPTag = cms.InputTag("ctppsProtons", "singleRP", "TEST")
process.ggll_aod.ppsRecoProtonMultiRPTag = cms.InputTag("ctppsProtons", "multiRP", "TEST")

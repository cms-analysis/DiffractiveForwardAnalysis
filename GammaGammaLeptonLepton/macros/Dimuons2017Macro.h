...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      //      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_LPAIRmumuElastic_Summer17_Pt50_xangle130_divergence30.root/ggll_aod/ntp1");
      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_DoubleMu2017B_merge.root/ggll_aod/ntp1");
      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_DoubleMu2017C_merge_final.root/ggll_aod/ntp1");
      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_DoubleMu2017D_merge.root/ggll_aod/ntp1");
      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_DoubleMu2017E_merge.root/ggll_aod/ntp1");
      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2017/ProtonReconstruction_DoubleMu2017F_merge.root/ggll_aod/ntp1");

      //      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2018/ProtonReconstruction_DoubleMu2018B_merge.root/ggll_aod/ntp1");
      //      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2018/ProtonReconstruction_DoubleMu2018C_merge.root/ggll_aod/ntp1");
      //      chain->Add("/eos/cms/store/group/phys_pps/ProtonRecoValidation/Dileptons/2018/ProtonReconstruction_DoubleMu2018D_merge.root/ggll_aod/ntp1");

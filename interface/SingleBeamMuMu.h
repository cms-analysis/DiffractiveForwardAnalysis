#ifndef DiffractiveForwardAnalysis_SingleBeamMuMu
#define DiffractiveForwardAnalysis_SingleBeamMuMu
...
class SingleBeamMuMu : public edm::EDAnalyzer {
 public:
  explicit SingleBeamMuMu(const edm::ParameterSet&);
  ~SingleBeamMuMu();

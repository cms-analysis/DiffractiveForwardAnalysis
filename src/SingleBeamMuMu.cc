 // -*- C++ -*-
//
// Package:    SingleBeamMuMu
// Class:      SingleBeamMuMu
// 
/**\class SingleBeamMuMu SingleBeamMuMu.cc GammaGammaLeptonLepton/SingleBeamMuMu/src/SingleBeamMuMu.cc
...
// $Id: SingleBeamMuMu.cc,v 1.4 2010/05/26 07:17:59 jjhollar Exp $
//
//
...
//
SingleBeamMuMu::SingleBeamMuMu(const edm::ParameterSet& pset)
{
...
void
SingleBeamMuMu::analyze(const edm::Event& event, const edm::EventSetup& iSetup)
{
  nMuonCand=0;
  nJetCand=0;
  nCaloCand=0;
...
void 
SingleBeamMuMu::fillDescriptions(ConfigurationDescriptions & descriptions) { 
  ...
  descriptions.add("ParameterDescriptionsForSingleBeamMuMu", iDesc); 
} 
